...
import numpy as np
import sys 
sys.path.append('/home/lj/projects/S3FD/')
...
# hand right left config
_C.HAND_LR = EasyDict()
_C.HAND_LR.TRAIN_FILE = './data/hand_lr_train.txt'
_C.HAND_LR.VAL_FILE = './data/hand_lr_val.txt'
_C.HAND_LR.OVERLAP_THRESH = 0.35 
