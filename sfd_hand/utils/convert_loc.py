...
def hand_left(box,false_num,change_img,point_loc,
    ...
    if not(box is None):
        ...
        keypoint_dir = "/home/data/cy/projects/piano/KJnotes/frames2/keypoint_img"
        cv2.imwrite(os.path.join(keypoint_dir, os.path.basename(path)), img)

        point_loc.append((ori_point[13], currentFrame))
        
        error_dir='/home/data/cy/projects/object_detect/sfd_hand/error_img/error1'
