...
def keypoint_det(frame,threshold):
    protoFile = "/home/data/cy/projects/object_detect/sfd_hand/caffe_model/pose_deploy.prototxt"
    weightsFile = "/home/data/cy/projects/object_detect/sfd_hand/caffe_model/pose_iter_102000.caffemodel"
    nPoints = 21
...
def draw_point(img,points):    #同时画两个手的
        POSE_PAIRS = [ [0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[0,9],[9,10],[10,11],[11,12],[0,13],[13,14],[14,15],[15,16],[0,17],[17,18],[18,19],[19,20] ]
        print(points)
